<x-layouts.app title="TemanLes — Belajar Bareng Guru yang Pas Buat Kamu">
    ...
    <section class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-8 lg:py-16">
        <div>
            ...
            <div class="flex flex-wrap gap-3.5 mb-8">
                <a href="{{ route('register') }}" class="bg-[#093C5D] text-[#5DF8D8] px-7 py-3.5 rounded-xl font-bold hover:bg-[#3B7597] hover:text-white transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 focus-visible:outline-none">
                    Daftar sebagai murid
                </a>
                <a href="{{ route('login') }}" class="border-2 border-[#3B7597]/30 bg-white px-7 py-3.5 rounded-xl font-bold text-[#093C5D] hover:bg-[#6FD1D7]/10 hover:border-[#3B7597] transition-all focus-visible:outline-none">
            ...
            @if($tutorCount > 0)
                <div class="inline-flex items-center gap-2 bg-[#5DF8D8]/20 border border-[#5DF8D8]/60 px-3.5 py-1.5 rounded-xl">
                    ...
                    <p class="text-xs sm:text-sm text-[#093C5D] font-medium">
                        <span class="font-bold text-[#093C5D]">{{ $tutorCount }} guru</span> sudah terverifikasi &amp; siap mengajar.
                    </p>
                </div>
            @endif
        </div>
    ...
    <section class="border-t border-gray-200/80 pt-16 pb-12 text-center bg-gradient-to-b from-transparent to-[#6FD1D7]/10 rounded-b-3xl">
        ...
        <a href="{{ route('register') }}" class="inline-block bg-[#093C5D] text-[#5DF8D8] px-8 py-4 rounded-xl font-extrabold hover:bg-[#3B7597] hover:text-white transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1 focus-visible:outline-none">
            Daftar Sekarang
        </a>
    </section>
