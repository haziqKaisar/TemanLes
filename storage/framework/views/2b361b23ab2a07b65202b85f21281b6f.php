...
<?php $component->withAttributes(['title' => 'Panel Admin']); ?>
    ...
    <section class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <h1 class="font-display mt-2 text-3xl font-extrabold tracking-tight text-[#093C5D] sm:text-4xl">
                Selamat datang kembali, <span class="text-[#3B7597]"><?php echo e(strtok(auth()->user()->name, ' ')); ?></span> <span aria-hidden="true">👋</span>
            </h1>
        ...
        <div class="flex min-w-[210px] items-center gap-3.5 rounded-2xl border border-[#6FD1D7]/30 bg-[#6FD1D7]/10 p-4 shadow-sm">
            ...
            <div>
                <p class="text-xs font-bold text-[#093C5D]"><?php echo e(now()->translatedFormat('l, d F Y')); ?></p>
                <p class="mt-0.5 text-xs font-semibold text-[#3B7597]"><?php echo e(now()->format('H:i')); ?> WIB</p>
            </div>
        </div>
    </section>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-[#093C5D] p-6 text-white shadow-lg shadow-[#093C5D]/20 transition-all hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="mt-2 text-3xl font-extrabold text-white"><?php echo e($stats['activeTutors']); ?></h3>
                </div>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-[#3B7597] p-6 text-white shadow-lg shadow-[#3B7597]/20 transition-all hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="mt-2 text-3xl font-extrabold text-white"><?php echo e($stats['students']); ?></h3>
                </div>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-[#6FD1D7] p-6 text-[#093C5D] shadow-lg shadow-[#6FD1D7]/25 transition-all hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="mt-2 text-3xl font-extrabold text-[#093C5D]"><?php echo e($stats['todayBookings']); ?></h3>
                </div>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-[#5DF8D8] p-6 text-[#093C5D] shadow-lg shadow-[#5DF8D8]/30 transition-all hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="mt-2 text-2xl font-extrabold text-[#093C5D] xl:text-3xl">Rp <?php echo e(number_format($stats['monthlyRevenue'], 0, ',', '.')); ?></h3>
                </div>
                <div class="grid h-12 w-12 place-items-center rounded-xl bg-[#093C5D]/10 text-[#093C5D]">
    ...
    <section class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm lg:col-span-6">
            ...
            <div class="space-y-3">
                <!-- Item 1: Pembayaran -->
                <a href="<?php echo e(route('admin.payments')); ?>" class="group flex items-center gap-4 rounded-xl border border-[#6FD1D7]/30 bg-[#6FD1D7]/10 p-4 transition-all hover:border-[#6FD1D7] hover:bg-[#6FD1D7]/20 hover:shadow-md">
                    ...
                    <span class="min-w-0 flex-1">
                        <span class="block text-sm font-bold text-[#093C5D]"><?php echo e($pendingPayments); ?> Pembayaran Menunggu</span>
                ...
                <a href="<?php echo e(route('admin.payouts')); ?>" class="group flex items-center gap-4 rounded-xl border border-[#5DF8D8]/40 bg-[#5DF8D8]/15 p-4 transition-all hover:border-[#5DF8D8] hover:bg-[#5DF8D8]/25 hover:shadow-md">
                    ...
                    <span class="min-w-0 flex-1">
                        <span class="block text-sm font-bold text-[#093C5D]"><?php echo e($pendingPayouts); ?> Permintaan Pencairan</span>
                ...
                <a href="<?php echo e(route('admin.tutors')); ?>" class="group flex items-center gap-4 rounded-xl border border-[#3B7597]/20 bg-[#3B7597]/5 p-4 transition-all hover:border-[#3B7597] hover:bg-[#3B7597]/15 hover:shadow-md">
        ...
        <a href="<?php echo e(route('admin.payments')); ?>" class="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-[#6FD1D7]/40 bg-gradient-to-b from-[#6FD1D7]/10 to-white p-6 shadow-sm transition-all hover:border-[#3B7597] hover:shadow-md lg:col-span-3">
            <div>
                ...
                <p class="mt-1 text-3xl font-black text-[#093C5D]"><?php echo e($pendingPayments); ?></p>
        ...
        <a href="<?php echo e(route('admin.payouts')); ?>" class="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-[#5DF8D8]/50 bg-gradient-to-b from-[#5DF8D8]/15 to-white p-6 shadow-sm transition-all hover:border-[#3B7597] hover:shadow-md lg:col-span-3">
            <div>
                ...
                <p class="mt-1 text-3xl font-black text-[#093C5D]"><?php echo e($pendingPayouts); ?></p>
    ...
    <section class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-12">
            ...
            <div class="mt-8 flex h-44 items-end justify-between gap-3 border-b border-gray-100 px-2 pb-2">
                <?php $__currentLoopData = $weeklyBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex h-full flex-1 flex-col items-center justify-end gap-1.5">
                        <span class="text-xs font-bold text-[#3B7597]"><?php echo e($booking['total'] ?: ''); ?></span>
                        <div class="w-full max-w-[36px] rounded-t-lg bg-[#3B7597] transition-all hover:bg-[#093C5D]" style="height: <?php echo e(max(10, ($booking['total'] / $maxBookings) * 110)); ?>px"></div>
                        <span class="text-xs font-semibold text-[#3B7597]"><?php echo e($booking['label']); ?></span>
                    </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm lg:col-span-6">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.payments')); ?>" class="text-xs font-bold text-[#3B7597] hover:text-[#093C5D] hover:underline">
            ...
            <div class="mt-4 divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center gap-3.5 py-3.5 transition-colors hover:bg-[#6FD1D7]/10 rounded-lg px-2">
                        <span class="grid h-9 w-9 shrink-0 place-items-center rounded-xl <?php echo e($activity['type'] === 'payment' ? 'bg-[#6FD1D7]/30 text-[#093C5D]' : 'bg-[#5DF8D8]/40 text-[#093C5D]'); ?>">
                        ...
                        <div class="min-w-0 flex-1">
                            <p class="truncate text-sm font-bold text-[#093C5D]"><?php echo e($activity['title']); ?></p>
                            <p class="truncate text-xs font-medium text-[#3B7597]"><?php echo e($activity['description']); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-xs font-extrabold text-[#093C5D]">+Rp<?php echo e(number_format($activity['amount'], 0, ',', '.')); ?></p>
                            <p class="mt-0.5 text-[10px] font-medium text-[#3B7597]"><?php echo e($activity['created_at']->diffForHumans()); ?></p>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\TemanLes\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>